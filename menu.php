                                            ...
                                            <div class="menu-item-card" data-item-name="<?= strtolower(htmlspecialchars($item['name'])) ?>" data-item-desc="<?= strtolower(htmlspecialchars($item['description'] ?? '')) ?>">
                                                ...
                                                <div class="menu-item-card__content">
                                                    ...
                                                    <div class="menu-item-card__price-row">
                                                        ...
                                                        <a href="https://wa.me/254722488706?text=I'm%20interested%20in%20<?= urlencode($item['name']) ?>%20from%20your%20menu" class="menu-item-card__whatsapp" target="_blank">
...
<a href="https://wa.me/254734639203?text=Hello%20Furusato!%20I'd%20like%20to%20make%20a%20reservation" class="whatsapp-float" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
